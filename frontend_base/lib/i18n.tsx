...
const dictionaries: Record<Locale, Record<string, string>> = {
  "pt-BR": {
    ...
    "config.compareQuantumClassical": "Comparar QUBO vs Baseline",
    ...
    "results.quantumFaster": "Eigensolver foi {speedup}x mais rápido",
    "results.quantumSlower": "Baseline foi {speedup}x mais rápido",
    ...
    "help.quantumLimitDesc": "A codificação com n² variáveis e o eigensolver exato escalam exponencialmente. Esta implementação limita a quatro locais.",
  ...
  "en-US": {
    ...
    "config.compareQuantumClassical": "Compare QUBO vs Baseline",
    "config.compareUnavailableTitle": "Comparison Unavailable",
    "config.compareUnavailableDesc": "The exact eigensolver comparison is limited to four locations. Reduce the current {count}-location instance to run it.",
    ...
    "results.quantumFaster": "Eigensolver was {speedup}x faster",
    "results.quantumSlower": "Baseline was {speedup}x faster",
    ...
    "help.step2Desc": "Select a classical route solver or the bounded exact eigensolver over the QUBO model.",
    ...
    "help.algorithmsIntro": "The platform compares classical TSP solvers with exact classical diagonalization of a QUBO-derived Hamiltonian:",
    ...
    "help.quantumNumpyDesc": "Exact classical diagonalization through Qiskit Optimization. It validates the QUBO formulation for small instances.",
    ...
    "help.quantumLimitDesc": "The n²-variable encoding and exact eigensolver scale exponentially. This implementation enforces a four-location limit.",
    ...
    // Tooltips
    "tooltip.algorithmInfo": "Choose a classical route solver or exact classical evaluation of the QUBO model",
